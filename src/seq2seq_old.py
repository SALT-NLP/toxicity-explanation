...
from transformers import BertForSequenceClassification,BartForConditionalGeneration,BartModel
...
class BartForConditionalGenerationJoinModel(BartModel):
  ...
  def forward(
    ...
    # In the latter case, we simply add directly to hidden states
      ...
      encoder_outputs.last_hidden_state = self.v_ReLU(encoder_outputs.last_hidden_state + enrichment)
    """
